    ...
    <body>
        <div class="content_product">        
            ...
            <div class="list_product">
                ...
                <div class="c_list">
                    <div class="c_btn"><button type='submit' name='btn' value="{$producto['cod']}"></button></div>
                    {* Recorremos el array asociativo - Datos del productos 'fila' *}
                    {foreach key=key item=value from=$producto}
                        {* Solo mostrar la columna [nombre_corto y PVP] *}
                        {if ($key === "nombre_corto")}
                            <div class="list"><span class="name">{$value}</span>
                        {/if}

                        {if ($key === "PVP")}
                            <span class="price">{$value}</span></div>
                        {/if}
                    {/foreach}
                </div>
                {/foreach}
